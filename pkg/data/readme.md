...
```bash
# 解压路径为 /var/lib/rancher/k3s/data/4012316506613ee8c3cffc1e5b5eca706270685d33585804b257e93ea98d1917（执行k3s --debug kubectl --help)即可生成,会自动打印解压路径， k3s项目地址为 ~/k3s/，请自行修正为自己电脑上的
...
# 自行安装 go-bindata
cd ~/k3s/pkg/data
go-bindata -pkg=data -o=./data.go -prefex=./data/ ./data/...    # 即可看到~/k3s/pkg/data/data.go
```
